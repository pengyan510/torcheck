...
def test_tensor_changing_check_with_changing_model(
    ...
    torcheck.add_tensor_changing_check(
        changing_model.fc1.weight,
        tensor_name="fc1.weight",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        changing_model.fc1.bias,
        tensor_name="fc1.bias",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        changing_model.fc2.weight,
        tensor_name="fc2.weight",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        changing_model.fc2.bias,
        tensor_name="fc2.bias",
        module_name="NeuralNet"
    )
    run_training(changing_model, dataloader, changing_model_optimizer)
...
def test_tensor_changing_check_with_unchanging_model(
    ...
    torcheck.register(unchanging_model_optimizer)
    torcheck.add_tensor_changing_check(
        unchanging_model.fc1.weight,
        tensor_name="fc1.weight",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        unchanging_model.fc1.bias,
        tensor_name="fc1.bias",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        unchanging_model.fc2.weight,
        tensor_name="fc2.weight",
        module_name="NeuralNet"
    )
    torcheck.add_tensor_changing_check(
        unchanging_model.fc2.bias,
        tensor_name="fc2.bias",
        module_name="NeuralNet"
    )
    with pytest.raises(
...
def test_tensor_nan_check_with_nan_model(
    ...
    with pytest.raises(
        RuntimeError,
        match=r"Module NeuralNet's fc1\.weight contains NaN\.\n.*fc1.bias contains NaN\.\n.*fc2.weight contains NaN\.\n.*fc2.bias contains NaN"
    ):
...
def test_tensor_nan_check_with_nonan_model(
    ...
    torcheck.add_tensor_nan_check(
        nonan_model.fc1.weight,
        tensor_name="fc1.weight",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_nan_check(
        nonan_model.fc1.bias,
        tensor_name="fc1.bias",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_nan_check(
        nonan_model.fc2.weight,
        tensor_name="fc2.weight",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_nan_check(
        nonan_model.fc2.bias,
        tensor_name="fc2.bias",
        module_name="NeuralNet"   
    )
...
def _test_tensor_inf_check_with_inf_model(
    ...
    with pytest.raises(
        RuntimeError,
        match=r"Module NeuralNet's fc1\.weight contains inf\.\n.*fc1.bias contains inf\.\n.*fc2.weight contains inf\.\n.*fc2.bias contains inf"
    ):
...
def test_tensor_inf_check_with_noinf_model(
    ...
    torcheck.add_tensor_nan_check(
        noinf_model.fc1.weight,
        tensor_name="fc1.weight",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_inf_check(
        noinf_model.fc1.bias,
        tensor_name="fc1.bias",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_inf_check(
        noinf_model.fc2.weight,
        tensor_name="fc2.weight",
        module_name="NeuralNet"   
    )
    torcheck.add_tensor_inf_check(
        noinf_model.fc2.bias,
        tensor_name="fc2.bias",
        module_name="NeuralNet"   
    )
